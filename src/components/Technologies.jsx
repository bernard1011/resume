...
const cardInfo = [
  ...
  },
  {
    ...
    name: "Linux",
    description:
      "I have basic knowledge of Bash scripting, user management, file permissions, and SSH. Currently, I am studying in the PortaOne Linux Networking and Administration program to deepen my knowledge and gain practical experience.",
  },
];
          ...
          {cardInfo.map((_, i) => (
            <button
              ...
              className={`w-2.5 h-2.5 rounded-full transition-all duration-200 ${
                i === currentCard ? "bg-indigo-400 scale-125" : "bg-indigo-900/60"
              }`}
            />
          ))}
        </div>
